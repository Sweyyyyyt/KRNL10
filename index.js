...
const TOKEN = 'MTMyNjk1MDEzNzMzOTA1MjA2Mg.G4y28C.ktvfLnpn_jz8sZdM8pn-dneooqF-p-2ryFKCGQ'; // Replace with your bot token
const WEBHOOK_URL = 'https://discord.com/api/webhooks/1326951961756569754/3aQ8eZuWnd0_gaRh6KxYZBvQ5Z1ULeObXZ8mJY-3ERncVQIOU7f7-wJ24y3tNOScfznG'; // Replace with your webhook URL
const DATABASE_URL = 'postgresql://neondb_owner:CedMkvVN0A4O@ep-restless-scene-a5z1i1xl.us-east-2.aws.neon.tech/neondb?sslmode=require'; // Replace with your PostgreSQL URL
const PORT = 3000;
...
(async () => {
    try {
        ...
        await rest.put(Routes.applicationCommands('1326950137339052062'), { body: commands });
...
client.on('interactionCreate', async (interaction) => {
    ...
    if (commandName === 'register') {
        ...
        const requiredRoleId = '1326952819722289216';
